...
/* this is library section we can insert package using import ,also dart provide third party package to use in our application*/
...
/*
  ...
  /* this is block comment 
     this is sdp lab
     my college name is ddu
  */

  // documentation comment
  /// i am a documenttation comment
  /// at your service
  

  /** 
   * this block documentation comment
   * here we can write multiple line comment
   */
  

/*
  //print function
  //print function print the data which is taken by input
  //it will create error because it will terminate string at bill's
...
/*
  ...
  /*
    ...
    it is allow condition type statement like if,else..etc
  */
